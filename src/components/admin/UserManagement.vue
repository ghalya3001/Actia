        ...
        <div class="modal-body">
          ...
          <div v-else class="role-callout callout-demote">
            ...
            <div class="callout-text text-amber">
              <strong>Privilèges restreints :</strong> L'accès aux formulaires HSE, à l'historique d'audit et à l'administration sera retiré. L'accès sera limité à l'Accueil, au Dashboard HSE et à son Profil.
            </div>
          </div>
